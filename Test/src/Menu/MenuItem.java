...
public class MenuItem extends JPanel {
    ...
    private Icon getIcon() {
        Color lightColor = FlatUIUtils.getUIColor("Menu.Icon.lightColor", Color.white);
        Color darkColor = FlatUIUtils.getUIColor("Menu.Icon.darkColor", new Color(254,212,169));
